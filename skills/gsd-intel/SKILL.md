...
Intel system is disabled. To activate:
  ...
  node $HOME/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node $HOME/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node $HOME/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node $HOME/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: $HOME/.codex/get-shit-done/bin/gsd-tools.cjs
